...
a persistence unit "ExamenWSCujiPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ExamenWSCuji\pom.xml":
...
artifact ("ExamenWSCuji.war") is already built. You can build
